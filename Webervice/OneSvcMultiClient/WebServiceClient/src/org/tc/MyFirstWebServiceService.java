 ...
 * 
 */
@WebServiceClient(name = "MyFirstWebServiceService", targetNamespace = "http://tc.org/", wsdlLocation = "http://localhost:9090/MyFirstWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYFIRSTWEBSERVICESERVICE_QNAME = new QName("http://tc.org/", "MyFirstWebServiceService");
    ...
    public MyFirstWebService getMyFirstWebServicePort() {
        return super.getPort(new QName("http://tc.org/", "MyFirstWebServicePort"), MyFirstWebService.class);
    }
    ...
    public MyFirstWebService getMyFirstWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tc.org/", "MyFirstWebServicePort"), MyFirstWebService.class, features);
    }
