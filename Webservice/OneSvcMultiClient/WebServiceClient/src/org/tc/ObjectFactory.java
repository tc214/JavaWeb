 ...
 * generated in the org.tc package. 
...
public class ObjectFactory {
    ...
    private final static QName _TestWebServiceResponse_QNAME = new QName("http://tc.org/", "testWebServiceResponse");
    private final static QName _TestWebService_QNAME = new QName("http://tc.org/", "testWebService");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.tc
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tc.org/", name = "testWebServiceResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tc.org/", name = "testWebService")
